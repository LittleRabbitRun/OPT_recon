...
int main(int argc, char *argv[]) 
{
 ...
 void usage(void)
  {
   fprintf(stderr, "Usage: projections_filename bandlimit_filter and options\n");
   fprintf(stderr, " -b bandlimit!\n");
   return 1;
   }
 ...
 result = bandlimit_filter(outputfile, bandlimit,n3,n2,n1,step2,step1);
 if(result) { return 1; }
