...
class Projections
{
 public:
  ...
  double rotOffset() const { return m_rotOffset;}
  void setRotOffset(double rotoffset) { m_rotOffset = rotoffset; }
 ...
 private:
  ...
  double m_rotOffset;   // the offset of the rotational axis from the center pixel in units of pixels
